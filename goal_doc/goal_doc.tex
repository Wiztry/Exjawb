...
\begin{tabular}{lll}
	...
	\textbf{Main supervisor:} & Björn Landfeld & \\
	\textbf{Examiner} & Björn Nyberg & \\
	\textbf{Project start} & 2017-05-01 & \\
	\textbf{Project end} & 2017-09-30 & \\
...
\begin{enumerate}
	...
	\item
		...
		time-consuming stage as we have to translate some protocol implementations
		to C/C++ from other programming languages to be compataible with Rosbridge.
		Further more we might have to look at formating the data that is being
		recieved and transmitted. After this stage the system should be ready for
		the testing stage.
	...
	\item
		...
		performing several stability tests. The stability tests consists of bringing
		the testplatform into environments where we can gather measurement over a
		long period of time. This will allow us to	measure how the performance of
		the	proposed protocols depend on the load on the wireless networks in the
		test area. These environments will be places heavily populated by network
		activity, in the Wi-Fi case this can be a large office park i.e. Ideon, for
		LTE (4G) it will be places more populated by people, such as train stations
		or arenas.
...
\signature{Main supervisor}{Björn Landfeldt}\\

\signature{Examiner}{Christian Nyberg}
