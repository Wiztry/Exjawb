...
environments where we can perform test over a long period of time to measure the
load average depending on activity in the area. These environments will be
places heavily populated by network activity, in the wifi case this can be a
large office park i.e. Ideon, for LTE (4G) it will be places more populated by
normal people, such as train stations or arenas.
